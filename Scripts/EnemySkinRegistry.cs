...
namespace AntlerShed.SkinRegistry
{
    ...
    {
        public const string modGUID = "AntlerShed.EnemySkinRegistry";
        ...
        internal static bool Debug => skinConfig.DebugSetting.Value;
        ...
        void Awake()
        {
            ...
            SkinLogger.LogMessage("Finished Patching Skin Events");
            ...
            if(Debug)
            {
                SkinLogger.LogMessage("Registered Vanilla Enemies");
            }
            ...
            SkinLogger.LogMessage("Registered Vanilla Moons");

            string path = System.IO.Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            AssetBundle bundle = AssetBundle.LoadFromFile(System.IO.Path.Combine(path, "AssetBundles/assets"));

            LethalConfigManager.AddConfigItem(new BoolCheckBoxConfigItem(skinConfig.DebugSetting, false));
            ...
            (
                ...
                (
                    "Enemy Skins", 
                    "Configuration Menu", 
                    "Opens the configuration menu for enemy skins", 
                    "Open Config", 
                    () =>
                    {
                        InitConfig();
                        ...
                        ConfigurationViewModel vm = new ConfigurationViewModel(moons.Moons.Values.ToArray(), enemySkins, configs.ToArray());
        ...
        public static void RegisterSkin(Skin skin)
        {
            ...
            SkinLogger.LogInfo($"Registered skin \"{skin.Label}\"");
        }
        ...
        public static EnemyEventHandler GetEnemyEventHandler(EnemyAI enemy)
        {
            return EventHandlers.GetEventHandler(enemy);
        }
        ...
        public static void RemoveEnemyEventHandler(EnemyAI enemy)
        {
            EventHandlers.RemoveBrackenEventHandler(enemy);
        }
